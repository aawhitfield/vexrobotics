//
//  ViewTeamTableViewController.swift
//  VEX Robotics
//
...
class ViewTeamTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        teamImage.image = selectedTeam.image
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("teamName", forIndexPath: indexPath) as UITableViewCell
